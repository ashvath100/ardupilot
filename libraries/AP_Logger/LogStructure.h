...
#define LOG_EXTRA_STRUCTURES \
    ...
    { LOG_NKF9_MSG, sizeof(log_NKF4), \
      "NKF9","QcccccfbbHBHHbbB","TimeUS,SV,SP,SH,SM,SVT,errRP,OFN,OFE,FS,TS,SS,GPS,PI,UI,UM", "s-----???-------", "F-----???-------" }, \
    ...
    { LOG_NKF14_MSG, sizeof(log_NKF4), \
      "NK14","QcccccfbbHBHHbbB","TimeUS,SV,SP,SH,SM,SVT,errRP,OFN,OFE,FS,TS,SS,GPS,PI,UI,UM", "s-----???-------", "F-----???-------" }, \
    ...
    { LOG_XKF4_MSG, sizeof(log_NKF4), \
      "XKF4","QcccccfbbHBHHbbB","TimeUS,SV,SP,SH,SM,SVT,errRP,OFN,OFE,FS,TS,SS,GPS,PI,UI,UM", "s------??-------", "F------??-------" }, \
    ...
    { LOG_XKF9_MSG, sizeof(log_NKF4), \
      "XKF9","QcccccfbbHBHHbbB","TimeUS,SV,SP,SH,SM,SVT,errRP,OFN,OFE,FS,TS,SS,GPS,PI,UI,UM", "s-----???-------", "F-----???-------" }, \
    ...
    { LOG_XKF14_MSG, sizeof(log_NKF4), \
      "XK14","QcccccfbbHBHHbbB","TimeUS,SV,SP,SH,SM,SVT,errRP,OFN,OFE,FS,TS,SS,GPS,PI,UI,UM", "s-----???-------", "F-----???-------" }, \
